...
import { X, Shield, Users, Package, ClipboardList, MapPin, CheckSquare, Settings, Bot, Eye, Save, Search, Loader2, Trash2 } from "lucide-react"
      ...
      if (response.ok) {
        ...
        if (data && data.CODUSUARIO) {
          setAccess({
            ...
            telaTabelaPrecos: data.TELA_TABELA_PRECOS !== 'N',
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                      <div className="flex items-center gap-2">
                        <ClipboardList className="w-4 h-4 text-muted-foreground" />
                        <Label htmlFor="tela-precos">Tabela de Preços</Label>
                      </div>
                      <Switch
                        id="tela-precos"
                        checked={access.telaTabelaPrecos}
                        onCheckedChange={(checked) => setAccess({ ...access, telaTabelaPrecos: checked })}
                      />
                    </div>
                  </div>
              ...
              <Card>
                <CardHeader className="pb-3">
                  ...
                  <CardDescription>
                    ...
                    Esta regra é aplicada em: Pedidos de Venda, Rotas, Visitas e IA.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <RadioGroup
              ...
              <Card>
                <CardHeader className="pb-3">
                  ...
                  <CardDescription>
                    ...
                    Esta regra é aplicada no catálogo de produtos em Pedidos de Venda e IA.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <RadioGroup
                  ...
                  {(access.acessoProdutos === 'MARCA' || access.acessoProdutos === 'GRUPO') && (
                    <div className="mt-4 p-4 bg-yellow-50 dark:bg-yellow-900/10 rounded-lg border border-yellow-200 dark:border-yellow-800">
                      <p className="text-sm text-yellow-700 dark:text-yellow-400">
                        A seleção de {access.acessoProdutos === 'MARCA' ? 'marcas' : 'grupos'} estará disponível em uma próxima versão.
                      </p>
                    </div>
                  )}
